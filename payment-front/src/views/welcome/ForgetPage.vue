        ...
        <transition mode="out-in" name="el-fade-in-linear">
            <div v-if="active === 0" style="text-align: center;margin: 0 20px;height: 100%">
                ...
                <div style="margin-top: 70px">
                    <el-button plain style="width: 270px;" type="danger" @click="confirmReset()">开始重置密码</el-button>
                </div>
            </div>
        </transition>
        <transition mode="out-in" name="el-fade-in-linear">
                ...
                <div style="margin-top: 50px">
                    <el-form ref="formRef" :model="form" :rules="rules" @validate="onValidate">
                        ...
                        <el-form-item prop="password_repeat">
                            <el-input v-model="form.password_repeat" :maxlength="16" placeholder="重复新密码" type="password">
                                <template #prefix>
                                    <el-icon><Lock /></el-icon>
                                </template>
                            </el-input>
